...
sorting='views' 			 #sorting options(random,toplist,relevance,date_added,views,favorites)
search='doom' 	 				#search ,you can leave empty.
...
ratio='16x9'						# specify ratio(s) ,use (,) to specify more rations (or leave empty),for example (16x9)
